...
import { Clock, Terminal, FileCode, GitBranch, AlertCircle, RefreshCw, Zap, Download, Filter } from '../Shared/icons';
        ...
        {!currentSessionId ? (
          ...
          <div className="divide-y divide-border">
            {filteredEvents.map((event) => (
              <div key={event.id} className="flex items-start gap-3 px-4 py-2.5 hover:bg-surface-3/50 transition-colors">
                <div className="mt-0.5 shrink-0">{eventIcon(event.event_type, event.tool)}</div>
